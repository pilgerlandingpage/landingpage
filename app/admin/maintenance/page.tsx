...
const INTEGRATIONS: IntegrationCard[] = [
...

    {
        ...
        fields: [
            ...
            { key: 'meta_whatsapp_triage_interest_reply', label: 'Resposta automatica - saiba mais', placeholder: 'Perfeito, entendi. Eu faco esse primeiro atendimento por aqui; os detalhes dos empreendimentos ficam com os especialistas. Ja deixei seu contato sinalizado para continuarem com voce. Pra te direcionar melhor: voce busca moradia, investimento ou ainda esta avaliando?', isSecret: false, type: 'textarea' },
            ...
            { key: 'meta_whatsapp_triage_privacy_reply', label: 'Resposta automatica - origem do contato', placeholder: 'Seu numero estava em uma base de contatos autorizados da imobiliaria. Se preferir, eu removo seu contato da lista por aqui mesmo.', isSecret: false, type: 'textarea' },
            {
            ...
            { key: 'meta_whatsapp_agent_unknown_reply', label: 'Resposta fallback do agente', placeholder: 'Fechado, vamos por partes. Voce prefere comecar por moradia, investimento ou pelo contexto da mensagem que recebeu?', isSecret: false, type: 'textarea' },
