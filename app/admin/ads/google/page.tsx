    ...
    return (
        <div>
            ...
            <div className="chart-card" style={{ marginBottom: 24 }}>
                <div className="chart-title">📥 Últimos Leads Capturados (Google Ads)</div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                        ...
                        <tbody>
                            ...
                            {internalStats.recentLeads.length === 0 && (
                                <tr>
                                    <td colSpan={4} style={{ padding: 40, textAlign: 'center', color: '#666' }}>Nenhum lead vindo do Google encontrado para este período</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
