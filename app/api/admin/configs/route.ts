...
const DEFAULT_CONFIGS: Record<string, string> = {
    ...
    meta_whatsapp_triage_interest_reply: 'Perfeito, entendi. Eu faco esse primeiro atendimento por aqui; os detalhes dos empreendimentos ficam com os especialistas. Ja deixei seu contato sinalizado para continuarem com voce. Pra te direcionar melhor: voce busca moradia, investimento ou ainda esta avaliando?',
    ...
    meta_whatsapp_triage_privacy_reply: 'Seu numero estava em uma base de contatos autorizados da imobiliaria. Se preferir, eu removo seu contato da lista por aqui mesmo.',
    ...
    meta_whatsapp_agent_unknown_reply: 'Fechado, vamos por partes. Voce prefere comecar por moradia, investimento ou pelo contexto da mensagem que recebeu?',
