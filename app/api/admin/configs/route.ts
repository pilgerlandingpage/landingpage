...
const DEFAULT_CONFIGS: Record<string, string> = {
    ...
    meta_whatsapp_triage_interest_reply: 'Legal, eu te ajudo sim. Para eu entender melhor: voce busca moradia, investimento ou quer primeiro entender a oportunidade que enviamos?',
    ...
    meta_whatsapp_agent_unknown_reply: 'Oi, tudo bem? Aqui e o atendimento da Guilherme Pilger Imoveis. Me conta como posso te ajudar por aqui.',
