...
const ENV_FALLBACKS: Record<string, string> = {
    ...
    meta_whatsapp_waba_accounts: 'META_WHATSAPP_WABA_ACCOUNTS',
    ...
    meta_whatsapp_agent_humanize_enabled: 'META_WHATSAPP_AGENT_HUMANIZE_ENABLED',
    meta_whatsapp_agent_typing_indicator_enabled: 'META_WHATSAPP_AGENT_TYPING_INDICATOR_ENABLED',
    meta_whatsapp_agent_split_messages: 'META_WHATSAPP_AGENT_SPLIT_MESSAGES',
    meta_whatsapp_agent_response_delay_min_ms: 'META_WHATSAPP_AGENT_RESPONSE_DELAY_MIN_MS',
    meta_whatsapp_agent_response_delay_max_ms: 'META_WHATSAPP_AGENT_RESPONSE_DELAY_MAX_MS',
    meta_whatsapp_agent_typing_ms_per_char: 'META_WHATSAPP_AGENT_TYPING_MS_PER_CHAR',
    meta_whatsapp_agent_chunk_delay_min_ms: 'META_WHATSAPP_AGENT_CHUNK_DELAY_MIN_MS',
    meta_whatsapp_agent_chunk_delay_max_ms: 'META_WHATSAPP_AGENT_CHUNK_DELAY_MAX_MS',
    meta_whatsapp_agent_audio_enabled: 'META_WHATSAPP_AGENT_AUDIO_ENABLED',
    meta_whatsapp_agent_response_mode: 'META_WHATSAPP_AGENT_RESPONSE_MODE',
...
const CONFIG_AGENT_CENTRAL_MAP: Record<string, string> = {
    ...
    meta_whatsapp_agent_prompt: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_enabled: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_history_limit: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_humanize_enabled: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_typing_indicator_enabled: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_split_messages: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_response_delay_min_ms: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_response_delay_max_ms: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_typing_ms_per_char: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_chunk_delay_min_ms: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_chunk_delay_max_ms: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_audio_enabled: 'agente-guilherme-meta-api',
    meta_whatsapp_agent_response_mode: 'agente-guilherme-meta-api',
    meta_whatsapp_triage_enabled: 'agente-guilherme-meta-api',
    meta_whatsapp_triage_ai_enabled: 'agente-guilherme-meta-api',
...
const DEFAULT_CONFIGS: Record<string, string> = {
    ...
    meta_whatsapp_agent_humanize_enabled: 'true',
    meta_whatsapp_agent_typing_indicator_enabled: 'true',
    meta_whatsapp_agent_split_messages: 'true',
    meta_whatsapp_agent_response_delay_min_ms: '900',
    meta_whatsapp_agent_response_delay_max_ms: '4200',
    meta_whatsapp_agent_typing_ms_per_char: '18',
    meta_whatsapp_agent_chunk_delay_min_ms: '700',
    meta_whatsapp_agent_chunk_delay_max_ms: '2200',
...
function normalizeConfigValue(key: string, value: string) {
    const boundedNumberConfigs: Record<string, { fallback: string; min: number; max: number }> = {
        ...
        meta_whatsapp_agent_response_delay_min_ms: { fallback: DEFAULT_CONFIGS.meta_whatsapp_agent_response_delay_min_ms, min: 0, max: 8000 },
        meta_whatsapp_agent_response_delay_max_ms: { fallback: DEFAULT_CONFIGS.meta_whatsapp_agent_response_delay_max_ms, min: 0, max: 10000 },
        meta_whatsapp_agent_typing_ms_per_char: { fallback: DEFAULT_CONFIGS.meta_whatsapp_agent_typing_ms_per_char, min: 0, max: 80 },
        meta_whatsapp_agent_chunk_delay_min_ms: { fallback: DEFAULT_CONFIGS.meta_whatsapp_agent_chunk_delay_min_ms, min: 0, max: 8000 },
        meta_whatsapp_agent_chunk_delay_max_ms: { fallback: DEFAULT_CONFIGS.meta_whatsapp_agent_chunk_delay_max_ms, min: 0, max: 10000 },
    ...
    if (key === 'meta_whatsapp_agent_response_mode') {
        const mode = String(value || '').trim().toLowerCase()
        return ['text', 'audio', 'mirror'].includes(mode) ? mode : DEFAULT_CONFIGS.meta_whatsapp_agent_response_mode
    }
