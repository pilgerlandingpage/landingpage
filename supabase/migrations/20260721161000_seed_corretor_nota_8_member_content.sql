...
FROM (
  SELECT
    ...
    'Livro digital Corretor Nota 8' AS title,
    'Material principal da compra. Cadastre a URL final do PDF ou leitor digital no admin.' AS description,
    'Este é o conteúdo principal do produto. Quando o arquivo final estiver publicado, cole a URL no campo URL do conteúdo dentro do admin de Produtos Digitais.' AS body,
