...
export default function WhatsAppFloatingButton() {
    ...
    return (
        <>
            <button
                className={`whatsapp-floating-btn ${isVisible ? 'visible' : ''}`}
                onClick={openChat}
            ...
            >
                ...
                <span className="whatsapp-floating-text">Fale Conosco</span>
            </button>
            ...
            <style jsx>{`
                ...
                /* Only show on desktop (768px+) — mobile has MobileNav */
