...
export default function MobileNav({
    ...
    const whatsappToneStyle = whatsappTone === 'brand'
        ? {
            backgroundColor: '#d3ad72',
            color: '#111111',
            boxShadow: '0 4px 14px rgba(184, 148, 95, 0.34)',
        }
        : {
