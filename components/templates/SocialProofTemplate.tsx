...
const testimonials = [
    { name: 'Carlos M.', text: 'Atendimento impecÃ¡vel. Encontraram exatamente o que eu procurava em menos de uma semana.', stars: 5 },
    { name: 'Fernanda S.', text: 'Profissionalismo de outro nÃ­vel. Recomendo a todos que buscam um imÃ³vel de alto padrÃ£o.', stars: 5 },
    { name: 'Roberto L.', text: 'Melhor experiÃªncia imobiliÃ¡ria que jÃ¡ tive. Equipe atenciosa e muito preparada.', stars: 5 },
]
    ...
    return (
        <div className="sp" style={{ '--pc': primaryColor } as React.CSSProperties}>
            ...
            <section className="sp-cta-section">
                ...
                <h2 className="sp-cta-title">NÃ£o perca esta oportunidade</h2>
                <p className="sp-cta-sub">Fale agora com um especialista e descubra condiÃ§Ãµes exclusivas.</p>
