...
export const OFFICIAL_COMMERCE_WHATSAPP_TEMPLATES: CommerceOfficialWhatsAppTemplate[] = [
  {
    ...
    internalBody: 'Oi {nome}, recebemos seus dados para a compra do {produto}. Seu pedido {numero_pedido} foi iniciado. Para continuar o pagamento com seguranca, acesse: {checkout_url}. Se precisar de ajuda, responda esta mensagem.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Oi {{1}}, recebemos seus dados para a compra do {{2}}. Seu pedido {{3}} foi iniciado. Para continuar o pagamento com seguranca, acesse: {{4}}. Se precisar de ajuda, responda esta mensagem.',
  ...
  },
  {
    ...
    internalBody: 'Oi {nome}, seu Pix para o {produto} foi gerado. Valor: {valor}. Ele vence em {pix_expira_em}. Para ver o QR Code ou copiar o Pix, acesse: {checkout_url}. Se precisar de ajuda, responda esta mensagem.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Oi {{1}}, seu Pix para o {{2}} foi gerado. Valor: {{3}}. Ele vence em {{4}}. Para ver o QR Code ou copiar o Pix, acesse: {{5}}. Se precisar de ajuda, responda esta mensagem.',
  ...
  },
  {
    ...
    internalBody: 'Oi {nome}, seu pagamento do {produto} ainda esta pendente. Assim que o Mercado Pago confirmar, seu acesso sera liberado automaticamente. Pedido: {numero_pedido}. Avisaremos por aqui.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Oi {{1}}, seu pagamento do {{2}} ainda esta pendente. Assim que o Mercado Pago confirmar, seu acesso sera liberado automaticamente. Pedido: {{3}}. Avisaremos por aqui.',
  ...
  },
  {
    ...
    internalBody: 'Pagamento aprovado, {nome}. Parabens pela compra do {produto}. Seu acesso ja foi liberado. Entre na area de membros por aqui: {access_link}. Guarde este link de acesso.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Pagamento aprovado, {{1}}. Parabens pela compra do {{2}}. Seu acesso ja foi liberado. Entre na area de membros por aqui: {{3}}. Guarde este link de acesso.',
  ...
  },
  {
    ...
    internalBody: 'Pagamento aprovado, {nome}. Seu acesso ao {produto} foi liberado. Entre pela area de membros: {member_area_url}. Guarde este link de acesso.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Pagamento aprovado, {{1}}. Seu acesso ao {{2}} foi liberado. Entre pela area de membros: {{3}}. Guarde este link de acesso.',
  ...
  },
  {
    ...
    internalBody: 'Oi {nome}, o pagamento do {produto} foi recusado pelo Mercado Pago. Voce pode tentar novamente com outro meio de pagamento por aqui: {checkout_url}. Se precisar de ajuda, responda esta mensagem.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Oi {{1}}, o pagamento do {{2}} foi recusado pelo Mercado Pago. Voce pode tentar novamente com outro meio de pagamento por aqui: {{3}}. Se precisar de ajuda, responda esta mensagem.',
  ...
  },
  {
    ...
    internalBody: 'Oi {nome}, o pagamento do pedido {numero_pedido} foi cancelado. Se quiser continuar, gere um novo pagamento com seguranca por aqui: {checkout_url}. Se precisar de ajuda, responda esta mensagem.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Oi {{1}}, o pagamento do pedido {{2}} foi cancelado. Se quiser continuar, gere um novo pagamento com seguranca por aqui: {{3}}. Se precisar de ajuda, responda esta mensagem.',
  ...
  },
  {
    ...
    internalBody: 'Oi {nome}, seu Pix do pedido {numero_pedido} vence em breve. Para concluir a compra do {produto}, acesse: {checkout_url}. Se precisar de ajuda, responda esta mensagem.',
    ...
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Oi {{1}}, seu Pix do pedido {{2}} vence em breve. Para concluir a compra do {{3}}, acesse: {{4}}. Se precisar de ajuda, responda esta mensagem.',
  ...
  },
  {
    ...
    internalBody: 'Oi {nome}, o Pix do pedido {numero_pedido} venceu. Para concluir a compra do {produto}, gere um novo pagamento por aqui: {checkout_url}. Se precisar de ajuda, responda esta mensagem.',
    variables: ['nome', 'numero_pedido', 'produto', 'checkout_url'],
    requiresOptIn: true,
    meta: {
      ...
      language: LANGUAGE,
      category: 'UTILITY',
      bodyText: 'Oi {{1}}, o Pix do pedido {{2}} venceu. Para concluir a compra do {{3}}, gere um novo pagamento por aqui: {{4}}. Se precisar de ajuda, responda esta mensagem.',
      bodyVariables: ['nome', 'numero_pedido', 'produto', 'checkout_url'],
      bodyExamples: ['Maria', 'PED-123ABC', 'Corretor Nota 8', 'https://guilhermepilger.ai/checkout/corretor-nota-8'],
      footerText: FOOTER,
    },
